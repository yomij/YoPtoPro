...
function compressFile(targetDir: string, localFile: fs.PathLike, releaseDir: string) {
  ...
  return new Promise((resolve, reject) => {
    ...
    archive.directory(path.resolve(__dirname, targetDir), releaseDir); // 存储目标文件并重命名
